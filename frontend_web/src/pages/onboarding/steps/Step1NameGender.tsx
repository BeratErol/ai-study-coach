...
export default function Step1NameGender() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto">
      ...
      <label className="block text-xl font-semibold text-gray-700 mb-3">İsmin</label>
      <input
        type="text"
        value={name}
        onChange={(e) => updateName(e.target.value)}
        placeholder="İsmin..."
        className="w-full h-16 border-2 border-gray-200 rounded-2xl px-6 text-xl focus:border-indigo-500 focus:ring-4 focus:ring-indigo-50 outline-none transition-all bg-white mb-10"
      />

      <label className="block text-xl font-semibold text-gray-700 mb-4">Cinsiyet</label>
      <div className="grid grid-cols-2 gap-5">
        {[
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center p-8 min-h-[140px] rounded-3xl border-2 cursor-pointer transition-all duration-200 select-none ${
              gender === opt.value
